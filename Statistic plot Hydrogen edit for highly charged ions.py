...
m_b_values_ion = numpy.array([10**2, 10**3, 10**4, 10**5, 10**6])
constraint_ion = numpy.array([10**-10, 10**-8, 10**-6, 10**-4, 10**-2])
pyplot.figure()
...
pyplot.plot(m_b_values_ion*(1/(2.6817268*(10**-4)))*(10**-6),constraint_ion, color='deeppink', linewidth=5.0, linestyle='--') 
