...
print numpy.divide(data_vs_theory(t)[2:,2], data_vs_theory_dir(t)[2:,2])
pyplot.figure()
pyplot.plot(numpy.arange(2,13), numpy.divide(data_vs_theory(t)[2:,2], data_vs_theory_dir(t)[2:,2]), marker='o', color='red', linestyle="None", label='Coulomb/Dirac' ,markersize=10)
pyplot.plot(numpy.arange(2,13), numpy.divide(data_vs_theory_dir(t)[2:,2],data_vs_quantum(t)[2:,2]), marker='x', color='blue', linestyle="None", label='Dirac/QED',markersize=15)
leg = pyplot.legend(loc=3, numpoints=1, fontsize= 20)


#pyplot.scatter(numpy.arange(2,5), (fs[2:5]*h)/(e*k), label='fine structure')
#pyplot.legend(loc='center left', bbox_to_anchor=(1, 0.5))
pyplot.axhline(y=0, color='black', linestyle=':')
pyplot.xlabel('$n$', fontsize=30)
pyplot.ylabel('$\Delta E_{n}^{\mathrm{exp}}-\Delta E_{n}^{\mathrm{the}}$', fontsize=30)
