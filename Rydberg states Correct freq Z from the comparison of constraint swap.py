...
def constraint_compare(Z, masses, Cop, A):
    ...
    for i in range(len(masses)):
        m_boson=masses[i]
        C=Cop[i]
        data_1[i] = C*integrate((exp(-m_boson*r)/((4*pi*r))*(R_nl(10,9,r,Z))**2)*r**2, (r,0,oo))
        data_2[i] = C*integrate((exp(-m_boson*r)/((4*pi*r))*(R_nl(30,29,r,Z))**2)*r**2, (r,0,oo))
...
constraint_compare(1,m_value, C_value, 1)
