...
pyplot.plot(m_b_values*(1/(2.6817268*(10**-4)))*(10**-6),constraint, color='red', linewidth=3.0, label='1000') 
pyplot.plot(m_b_values_H*(1/(2.6817268*(10**-4)))*(10**-6), constraint_H, color='darkgreen',linewidth=3.0, label='1')
