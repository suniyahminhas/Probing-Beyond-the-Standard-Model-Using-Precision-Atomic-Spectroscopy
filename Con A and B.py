...
constraint_h = numpy.array([10**-11, 10**-9, 10**-7, 10**-5, 10**-3, 10**-1])
...
pyplot.plot(m_b_values_h*(1/(2.6817268*(10**-4)))*(10**-6),constraint_h, color='limegreen', linewidth=5.0) 
#pyplot.plot(m_b_values*(1/(2.6817268*(10**-4)))*(10**-6),constraint((2,0,1),(4,1,1),0.15*10**6), color='blue', label='other', linewidth=5.0) 
